...
<center><table>
    <form action="../php/document.php" method="post">
    <tr>
        <td>ingrese N. de documento</td><td><input type="text" name="usuario" required></td>
    </tr>
<tr><td><input type="submit" value="GENERAR CERTIFICADO"></td></tr>
